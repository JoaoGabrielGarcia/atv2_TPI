...
class ProdutoModal extends React.Component<ProdutoModalProps, ProdutoModalState> {
  constructor(props: ProdutoModalProps) {
    super(props);
    this.state = {
      form: {
        nome: '',
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
        <div className="bg-gray-700 rounded-lg shadow-lg w-full max-w-lg p-8 relative">
          ...
          <h2 className="text-xl font-bold mb-4 text-white">Cadastrar Produto</h2>
